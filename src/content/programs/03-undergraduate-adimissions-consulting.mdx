...
hero:
  ...
  action:
    ...
    icon: true
  image:
    src: '@images/illustrations/undergrad-consult.png'
    alt: 'toddlers playing with block toys'
infoSection:
  headline: Undergraduate Admissions Consulting
  text: 8학년을 시작으로 대학에 입학하기까지 학년별로 선정 및 진행되며, 학생이 실제 이룰 수 있는 장기적인 계획을 설계하고, 학생의 장점을 극대화시키는 방향으로 진행됩니다. 베이글에듀가 12년간 오랜 시간 쌓아온 경험, 그리고 그 과정에서 실제 거둔 성공들을 바탕으로 설계된 플랜으로 당신에게 어울리는 목표 대학과 전공을 찾도록 도와드립니다. 베이글에듀 소속의 최상위권 명문대 출신 컨설턴트들과 함께하는 체계적인 We Are Elite Program을 통해 자신만의 브랜드를 만들어 나가 보아요. 
...
descriptionSection:
  portraitImage:
    src: '@images/stock/undergraduate-image-0.png'
    alt: early education students doing arts and crafts on circular table
  squareImages:
    - src: '@images/stock/undergraduate-image-1.webp'
      alt: teacher and students folding colorful paper together
    - src: '@images/stock/undergraduate-image-2.webp'
